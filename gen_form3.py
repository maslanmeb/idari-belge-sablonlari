...
EXTRA_STYLE = """<style>
  ...
  .bottom-cols{ display:flex; gap: 24px; margin-top: 18px; }
...
# ---------------- Identity table ----------------
ident_rows = [
    field_row_single("ADI &ndash; SOYADI", input_field("p_ad")),
    field_row_single("BABA ADI", input_field("p_baba")),
    "      <tr><td class=\"label\">DOĞUM YERİ VE TARİHİ</td><td>"
        + input_field("p_dogumyeri") + '<span style="display:inline-block;width:8px;"></span>'
        + '<input type="date" style="width:150px;">' + "</td></tr>",
    field_row_single("GÖREVİ", input_field("p_gorev")),
    field_row_single("ÜNVANI", input_field("p_unvan")),
    ...
    field_row_single("TC KİMLİK NO", input_field("p_tc", "tc")),
    field_row_single("DİLEKÇE KONUSU", input_field("p_konu")),
]
...
paragraphs = '''    <div class="section-title">Dilekçe Metni</div>
