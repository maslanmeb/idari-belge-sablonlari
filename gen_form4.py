...
EXTRA_STYLE = """<style>
  ...
  .sig-table .sig-name{ font-weight:bold; min-height:1.3em; outline:none; cursor:text; }
  .sig-table .sig-name:empty::before{ content: attr(data-placeholder); color:#aaa; font-style:italic; font-weight:normal; }
  .sig-table .sig-name:focus{ background:#fbfbea; }
...
signature = '''    <div class="sig-wrap">
      <table class="sig-table">
        ...
        <tr><td class="sig-name" contenteditable="true" data-placeholder="Ad SOYAD"></td></tr>
...
contact = '''    <table class="meta contact-table">
      <tr><td class="label">TC Kimlik No</td><td><input type="text" inputmode="numeric" class="tc-field" placeholder="TC Kimlik No"></td></tr>
      <tr><td class="label">Telefon No</td><td><input type="tel" placeholder="0532 - 123 45 67"></td></tr>
